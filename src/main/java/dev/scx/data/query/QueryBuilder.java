...
public final class QueryBuilder {
    ...
    public static Query query(Query oldQuery) {
        if (oldQuery == null) {
            throw new NullPointerException("oldQuery cannot be null");
        }
    ...
    public static Condition condition(String selector, ConditionType conditionType, Object value, BuildControl... controls) {
        var useExpression = toUseExpression(controls);
        var useExpressionValue = toUseExpressionValue(controls);
        var skipIfInfo = toSkipIfInfo(controls);
